...
InputClass=InputDataRemnant(:,2);%InputClass(InputClass==1)=0;InputClass(InputClass==2)=0;InputClass(InputClass==3)=1;
InputClass(InputClass==0)=0;
InputClass(InputClass==1)=0;
InputClass(InputClass==2)=1;
...
%Model = fitctree(SortedInputFeatures(:,1),InputClass,'Surrogate','on','CategoricalPredictors',IsDist,'Prior','Uniform','CrossVal','on');
for ft=5:5
